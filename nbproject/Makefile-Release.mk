...
${OBJECTDIR}/_ext/765732527/cmd.o: ../X86HOST/cmd.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/765732527/cmd.o ../X86HOST/cmd.cpp

${OBJECTDIR}/_ext/765732527/main.o: ../X86HOST/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/765732527
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/765732527/main.o ../X86HOST/main.cpp

${OBJECTDIR}/_ext/765732527/mem.o: ../X86HOST/mem.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/765732527
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/765732527/mem.o ../X86HOST/mem.cpp
